using z.Avatar.BlockGenerators;
...
namespace z.Avatar.Managers
{
    ...
    public class IconGenerator
    {
        ...
        public IconGenerator(string algorithm)
            : this(algorithm, new Size(400, 400)) { }

        public IconGenerator(string algorithm, Size size)
            : this(algorithm, size, Color.Transparent) { }

        public IconGenerator(string algorithm, Size size, Color defaultBackgroundColor)
            : this(algorithm, size, defaultBackgroundColor, new Size(6, 6)) { }

        public IconGenerator(string algorithm, Size size, Color defaultBackgroundColor, Size defaultBlocks)
            : this(algorithm, size, defaultBackgroundColor, defaultBlocks, Encoding.UTF8) { }

        public IconGenerator(string algorithm, Size size, Color defaultBackgroundColor, Size defaultBlocks, Encoding encoding)
            : this(algorithm, size, defaultBackgroundColor, defaultBlocks, encoding, IconGenerator.DefaultBlockGeneratorsConfig) { }

        public IconGenerator(string algorithm, Size size, Color defaultBackgroundColor, Size defaultBlocks, Encoding encoding, IBlockGenerator[] blockGenerators)
            : this(algorithm, size, defaultBackgroundColor, defaultBlocks, encoding, blockGenerators, IconGenerator.DefaultBrushGeneratorConfig) { }

        public IconGenerator(string algorithm, Size size, Color defaultBackgroundColor, Size defaultBlocks, Encoding encoding, IBlockGenerator[] blockGenerators, IBrushGenerator brushGenerator)
        {
        ...
        {
            var ha = CryptoConfig.CreateFromName(algorithm) as HashAlgorithm; //HashAlgorithm.Create(); //algorithm
            if (ha == null)
        ...
        public IconGenerator WithAlgorithm(string algorithm)
        {
            DefaultAlgorithm = algorithm;
            return this;
        }

        public IconGenerator WithSize(int width, int height)
        {
            return WithSize(new Size(width, height));
        }

        public IconGenerator WithSize(Size size)
        {
            DefaultSize = size;
            return this;
        }

        public IconGenerator WithBlocks(int horizontal, int vertical)
        {
            return WithBlocks(new Size(horizontal, vertical));
        }

        public IconGenerator WithBlocks(Size size)
        {
            DefaultBlocks = size;
            return this;
        }

        public IconGenerator WithEncoding(Encoding encoding)
        {
            DefaultEncoding = encoding;
            return this;
        }

        public IconGenerator WithBackgroundColor(Color color)
        {
            DefaultBackgroundColor = color;
            return this;
        }

        public IconGenerator WithBlockGenerators(IBlockGenerator[] blockGenerators)
        {
            DefaultBlockGenerators = blockGenerators;
            return this;
        }

        public IconGenerator WithBrushGenerator(IBrushGenerator brushGenerator)
        {
            DefaultBrushGenerator = brushGenerator;
            return this;
        }
